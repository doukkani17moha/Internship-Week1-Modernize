...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <!--  Row 1 -->
        <div class="row">
                <h5 class="card-title fw-semibold mb-4">All Doctors</h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Speciality</h6>
                        </th>
                        <th class="border-bottom-0">
                    ...
                    <?php
                       ...
                       foreach($allDoctors as $doctors){
                        ?>
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0"><?php echo $doctors->getdoctorid(); ?></h6></td>
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal"><?php echo $doctors->getdoctorname(); ?></p>
                        </td>

                        <td class="border-bottom-0">
                         <p class="mb-0 fw-normal">
                          <a href="#" class="blog-image-link" data-image="<?php echo $doctors->getdoctorimg(); ?>">
                             <?php echo $doctors->getdoctorimg(); ?>
                         </a>
                           </p>
                        </td>

                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal"><?php echo $doctors->getdoctoremail(); ?></p>
                        </td>

                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal"><?php echo $doctors->getdoctorphone(); ?></p>
                        </td>

                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal"><?php echo $doctors->getdoctorspeciality(); ?></p>
                        </td>

                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal"><?php echo $doctors->dateajoutation(); ?></p>
                        </td>
                      </tr> 
                      <tr class="popup-row">
  <td colspan="5">
  ...
  Array.from(imageLinks).forEach(function(link) {
    link.addEventListener('click', function(event) {
      ...
      popupImage.src = 'http://localhost/admin/admin/assets/images/doctors/' + imageUrl;
