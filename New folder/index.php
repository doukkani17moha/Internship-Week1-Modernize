              ...
              <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    <h5 class="card-title fw-semibold">Appointments Overview</h5>
                  </div>
                  <div>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <div class="mb-4">
                <h5 class="card-title fw-semibold">Available doctors</h5>
                  </div>
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <?php
                      ...
                      $doctor = new Doctor();
                      $allDoctors = $doctor->getactiveDoctors();
                      $doctorCounter =0;
                     ...
                     <h6 class="fw-semibold mb-1"><?php echo $doctors->getdoctorname(); ?></h6>
                     </td>
                      <td class="border-bottom-0">
                      <div class="d-flex align-items-center gap-2">
                      <span class="badge bg-success rounded-3 fw-semibold">available</span>
                      </div>
                      </td>
                  </tr>
    <?php $doctorCounter++; } ?>
                ...
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <?php
                       ...
                       $allAppointements = $appointement->latestAppointements();
                       $appointementcounter=0;
                       foreach($allAppointements as $appointements){
                        if ($appointementcounter >= 5) {
                          break; 
                        }
                        ?>
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Designed and Developed by Mohamed & Hamza</p>
        </div>
      </div>
    </div>
  </div>
